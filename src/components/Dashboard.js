  ...
  return (
    <>
      {!completed ? (
        ...
        <>
          <div className="bg-gradient-to-r from-[#0f0f0f] to-[#434343] flex bg-opacity-80 backdrop-blur-md">
            <Header />
          </div>
          <div className="py-4 px-4 bg-gradient-to-r from-[#0f0f0f] to-[#434343] bg-opacity-80 backdrop-blur-md">
